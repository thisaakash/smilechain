...
export default class App extends React.Component {
  state = {selectedVerifier: GOOGLE, loginHint: '', consoleText: '',consolePText:''};
  ...
  login = async () => {
    ...
    try {
      ...
      this.setState({
        ...
        consolePText: `PrivateKey: ${loginDetails.privateKey}`,
  ...
  render() {
    const {selectedVerifier, consoleText,consolePText} = this.state;
    return (
      <View style={styles.container}>
        ...
        <View style={styles.console}>
          ...
          <Text style={styles.consoleText}>{consolePText}</Text>
        </View>
      </View>
    );
  }
